...
#Comp	ssh $1 -p 26 /home/mk_arrays_master fc raid10 sas_hdd 168 8 21 128 200 NOSCRUB COMPRESSED
	ssh $1 -p 26 /home/mk_arrays_master fc raid10 sas_hdd 168 8 21 128 200   NOSCRUB AUTOEXPAND
#	ssh $1 -p 26 /home/mk_arrays_master fc raid10 sas_hdd 168 8 21 32 200   NOSCRUB
	sleep 60
